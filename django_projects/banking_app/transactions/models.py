...
class Account(models.Model):
    account_num = models.CharField(max_length=13, unique=True, blank=False, null=False)
...
class BillInfo(models.Model):
    ...
    payee_account = models.ForeignKey(Account, on_delete=models.SET_NULL, null=True)
