        ...
        <div>
            ...
            {modalOpen && (
                <div className="relative">
                    ...
                    ></div>
                    <Modal setProducts={setProducts} products={products} setTempProducts={setTempProducts} type="sales"/>
                </div>
            )}
            <div className="relative top-20 px-5 lg:ml-[18.5%] bg-slate-200">
                <h1 className="text-2xl font-medium text-blue-500">IBYIHARIYE - KUGURISHA</h1>
                <div className="bg-white rounded-sm shadow-sm w-full p-4 mb-5">
                    ...
                    <div className="my-2 font-light overflow-auto horizontal-custom-scrollbar">
                        <div className="flex w-full [&>*]:w-3/12 md:[&>*]:w-2/12 text-blue-500 font-bold [&>*]:border-r [&>*]:border-l [&>*]:border-b [&>*]:border-t [&>*]:px-1 [&>*]:shrink-0">
                            ...
                            <h1>Igiciro wagurishijeho</h1>
                            <h1>Ingano (Quantity)</h1>
                            <h1>Action</h1>
                        </div>
                                    ...
                                    <div key={index} className="flex w-full [&>*]:w-3/12 md:[&>*]:w-2/12 [&>*]:px-1 [&>*]:shrink-0 ">
                                        ...
                                        {updateModalOpen && (
                                            <div className="">
                                                ...
                                                <UpdateModal product={selectedProduct} products={products} setTempProducts={setTempProducts} type="sales"/>
                                            </div>
                                        )}
                                    </div>
                                )
